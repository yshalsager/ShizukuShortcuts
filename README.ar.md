...
- يدعم نسخاً احتياطياً واستعادةً يدوياً للإجراءات المخصصة عبر منتقي الملفات في أندرويد (استعادة باستبدال كامل)
- يصدّر ملفات النسخ الاحتياطي بصيغة JSON باسم افتراضي يحوي طابعاً زمنياً مثل `shizuku-custom-actions-backup-20260404-153045.json`
...
- `MainActivity`: تنسيق شاشة التشغيل وعقود النسخ الاحتياطي والاستعادة واستدعاءات الإجراءات
- `MainScreen`: واجهة Compose مختصرة تعرض حالة واحدة وتعليمات داخلية وصفوف الإجراءات ومربعات الحوار
...
- `CustomActionsBackup`: تسمية ملف النسخ الاحتياطي والتسلسل/فك التسلسل JSON ومساعدات القراءة/الكتابة عبر SAF
